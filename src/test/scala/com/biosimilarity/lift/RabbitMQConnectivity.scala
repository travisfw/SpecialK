...
object RabbitMQConnectivityTestSpecs extends Specification
{
  ...
  val RABBIT_PORT_TARGET = 4444
// use these when wanting to test multi ports
//  val RABBIT_PORT_SOURCE = 4444
//  val RABBIT_PORT_TARGET = 5555


// You can replicate by copying \src\main\resources\rabbitmq-multi-server.bat to your // rabbitmq_server-2.5.1\sbin and running

// \rabbitmq_server-2.5.1\sbin\rabbitmq-multi-server.bat
// \rabbitmq_server-2.5.1\sbin\rabbitmq-multi-server.bat "r4444" 4444

// Then 

// mvn test -Dtest=RabbitMQConnectivityTest
